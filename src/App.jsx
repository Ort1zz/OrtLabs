...
const getStyles = (isDark) => `
  ...
  /* NOVA ANIMAÇÃO DO CARD DO RODAPÉ (SLIDE UP) */
  ...
  /* CLASSE ATUALIZADA PARA O CARD DO RODAPÉ */
  ...
  /* Portal Iframe Effect (Ajustado para ocupar 100% do card) */
  ...
  /* Truque para iframe fullscreen responsivo */
  .portal-iframe {
     position: absolute;
     top: 0; left: 0;
     width: 200%; /* Renderiza 2x maior... */
     height: 200%; 
     border: none;
     transform: scale(0.5); /* ...e encolhe para 1x */
     transform-origin: top left; /* Fixa no canto superior esquerdo */
     pointer-events: none; 
  }
...
const ProfileCard = ({ isDark }) => {
  ...
  return (
    <div className="perspective-1000 w-full h-full flex items-center justify-center p-4">
      <div ref={cardRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} onClick={scrollToContact} style={{ transform: `rotateX(${rotate.x}deg) rotateY(${rotate.y}deg)`, transition: 'transform 0.1s ease-out' }} className={`relative w-[320px] h-[480px] rounded-3xl overflow-hidden shadow-2xl group transition-all duration-500 hover:shadow-[0_20px_50px_-10px_rgba(147,51,234,0.3)] preserve-3d cursor-pointer ${isDark ? 'bg-slate-900 ring-1 ring-slate-800' : 'bg-white ring-1 ring-slate-200'}`}>
        ...
        <div className="absolute inset-0 h-full w-full">
            <div className={`absolute inset-0 bg-gradient-to-br ${isDark ? 'from-purple-900 to-slate-900' : 'from-purple-100 to-white'}`}></div>
            <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
            <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-transparent opacity-90"></div>
        </div>
...
// --- NOVA LISTA INTERATIVA (ProjectShowcase - Minimalist & Fluid) ---
const projects = [
  { id: 1, title: "VitaeSenior", category: "Health Tech", year: "2024", image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80", description: "Plataforma de cuidado e gestão para saúde sênior, com integração de telemedicina e monitoramento em tempo real.", tech: ["React", "Tailwind", "Node.js"], link: "https://www.vitaesenior.com.br", comingSoon: false },
  { id: 2, title: "Frizzo Corretora", category: "Fintech", year: "2023", image: "https://images.unsplash.com/photo-1556742049-0cfed4f7a07d?w=800&q=80", description: "Soluções inteligentes em seguros com dashboard interativo para cotações e gestão de apólices.", tech: ["HTML", "Tailwind CSS", "React", "Vite"], link: "#", comingSoon: true },
  { id: 3, title: "ORTLabs", category: "Design & Dev", year: "2025", image: "https://images.unsplash.com/photo-1555099962-4199c345e5dd?w=800&q=80", description: "Este portfólio. Uma experiência imersiva com animações fluidas, tema dinâmico e design de vidro.", tech: ["HTML", "Tailwind CSS", "React", "Vite"], link: "https://www.ortzstudios.com.br", comingSoon: false },
  { id: 4, title: "Luana Dias", category: "Portfólio", year: "2024", image: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=800&q=80", description: "Portfólio profissional minimalista desenvolvido para fortalecer a presença digital e marca pessoal.", tech: ["HTML", "Tailwind CSS", "React", "Vite"], link: "#", comingSoon: false }
];
            ...
            <div className="project-preview">
                {projects.map((project, index) => !project.comingSoon && (
                    <div key={project.id} className={`absolute inset-0 w-full h-full transition-opacity duration-500 flex items-center justify-center overflow-hidden ${activeIndex === index ? 'opacity-100 z-20' : 'opacity-0 z-0'}`}>
                        ...
                        {/* IFRAME / PORTAL (MOSTRA SITE SE LINK VÁLIDO E NÃO FOR #) */}
                        {activeIndex === index && project.link && project.link !== '#' ? (
                            <div className="portal-frame-wrapper active">
                                <iframe 
                                    ...
                                    loading="lazy"
                                />
                                {/* Overlay invisível para evitar captura de mouse pelo iframe */}
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <Reveal delay={200}>
                            ...
                            <div className={`prose prose-invert prose-lg leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                                ...
                                <p className="mb-6">A OrtLabs nasceu dessa paixão: ser a ponte entre sua visão e a realidade digital. Meu objetivo é ajudar empresas a tirarem seus projetos do papel, entregando soluções que não apenas funcionam, mas que elevam a marca e geram resultados reais.</p>
